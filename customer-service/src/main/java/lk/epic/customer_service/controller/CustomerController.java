...
public record CustomerController(CustomerService customerService, ProductServiceClient productServiceClient) {
    @GetMapping
    public String test() {
        return "Hello";
    }
...
//        customerService.registerCustomer(registrationRequest);
    ...
    public ResponseEntity<ResponseUtil<List<ProductDTO>>> getAllProductsFromCustomerController() {
